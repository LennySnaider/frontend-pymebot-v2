/**
 * frontend/src/app/(protected-pages)/superadmin/verticals-manager/_components/VerticalsManager.tsx
 * Componente para la gestión de verticales de negocio
 * @version 1.0.0
 * @updated 2025-05-01
 */
...
import { useVerticalsStore, Vertical } from '@/app/(protected-pages)/superadmin/subscription-plans/_store/verticalsStore'
import VerticalFormModal from '@/app/(protected-pages)/superadmin/subscription-plans/_components/VerticalFormModal'
import {
    PiPlusBold,
    PiPencilSimpleBold,
    PiTrashSimpleBold,
    ...
    return (
        <>
            <AdaptiveCard
                ...
                bodyClass="p-0"
                header={{
                    content: <h4>Gestión de Verticales de Negocio</h4>,
                    extra: (
                        <div className="flex space-x-2">
                            <Button
                                size="sm"
