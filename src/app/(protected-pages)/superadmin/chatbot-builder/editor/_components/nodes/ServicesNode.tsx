/**
 * frontend/src/app/(protected-pages)/superadmin/chatbot-builder/editor/_components/nodes/ServicesNode.tsx
 * Nodo para mostrar servicios en el flujo de chatbot
 * @version 1.0.0
 * @created 2025-05-21 - Migrado desde components/view/ChatbotBuilder/nodes/
 * @description Permite mostrar servicios disponibles en el chatbot con filtros y opciones de ordenación
 */
...
const ServicesNode = ({ data, selected }: NodeProps) => {
  return (
    <NodeWrapper 
      selected={selected} 
    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          <PiRulerDuotone className="text-purple-500 text-xl mr-2" />
          <span className="font-semibold text-gray-900 dark:text-gray-100">
            {data.label || 'Mostrar Servicios'}
          </span>
        </div>
      ...
      <div className="mt-2 bg-gray-50 dark:bg-gray-700 p-2 rounded text-sm text-gray-700 dark:text-gray-300 max-w-[250px] break-words">
        {data.message_template || 'Servicios disponibles: {{services_list}}'}
      </div>
...
export default memo(ServicesNode)