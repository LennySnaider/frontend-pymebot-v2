/**
 * frontend/src/app/(protected-pages)/superadmin/chatbot-builder/editor/_components/nodes/BookAppointmentNode.tsx
 * Nodo para agendar citas en el flujo de chatbot
 * @version 1.0.0
 * @created 2025-05-21 - Migrado desde components/view/ChatbotBuilder/nodes/
 * @description Permite agendar citas con opciones para actualizar etapa del lead y enviar confirmaciones
 */
...
const BookAppointmentNode = ({ data, selected }: NodeProps) => {
  const { 
    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          <PiCalendarCheckBold className="text-green-500 text-xl mr-2" />
      ...
      <div className="mt-2 bg-gray-50 dark:bg-gray-700 p-2 rounded text-sm text-gray-700 dark:text-gray-300 max-w-[250px] break-words">
        Agendar una cita con la información seleccionada
      </div>
...
export default memo(BookAppointmentNode)