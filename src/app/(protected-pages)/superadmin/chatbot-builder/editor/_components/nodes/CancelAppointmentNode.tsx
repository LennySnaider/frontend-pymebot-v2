/**
 * frontend/src/app/(protected-pages)/superadmin/chatbot-builder/editor/_components/nodes/CancelAppointmentNode.tsx
 * Nodo para cancelar citas en el flujo de chatbot
 * @version 1.0.0
 * @created 2025-05-21 - Migrado desde components/view/ChatbotBuilder/nodes/
 * @description Permite cancelar citas existentes con opciones para actualizar etapa del lead y notificar agentes
 */
...
const CancelAppointmentNode = ({ data, selected }: NodeProps) => {
  const { 
    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          <PiCalendarXBold className="text-red-500 text-xl mr-2" />
          <span className="font-semibold text-gray-900 dark:text-gray-100">
            {data.label || 'Cancelar Cita'}
          </span>
        </div>
