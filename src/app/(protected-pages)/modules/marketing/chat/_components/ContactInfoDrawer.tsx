...
import LeadTemplateProgress from './LeadTemplateProgress'
import LeadCollectedData from './LeadCollectedData'
...
const ContactInfoDrawer = () => {
    ...
    const isLead = selectedChat.id?.startsWith('lead_')
    const leadId = isLead ? selectedChat.id?.replace('lead_', '') : undefined
        ...
        >
            ...
            {!isEmpty(data?.userDetails) && (
                <ScrollBar className="h-[calc(100%-30px)]">
                    ...
                    {/* Mostrar progreso de plantillas y datos recolectados si es un lead */}
                    {isLead && leadId && (
                        <div className="mt-8 space-y-6">
                            <LeadTemplateProgress leadId={leadId} />
                            <LeadCollectedData leadId={leadId} />
                        </div>
                    )}
