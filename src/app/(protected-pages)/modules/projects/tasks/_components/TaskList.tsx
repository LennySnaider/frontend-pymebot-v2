...
// const getStatusTranslationKey = (statusKey: string): string => {
//     switch (statusKey) {
//         case 'Pending':
//             return 'status.pending'
//         case 'In Progress':
//             return 'status.inProgress'
//         case 'Completed': // Assuming 'Completed' might also be a key
//             return 'status.completed'
//         default:
//             return statusKey // Fallback to the original key if no match
//     }
// }
                                    ...
                                    {(provided) => (
                                        ...
                                        >
                                            <div className="flex items-center gap-2 mb-4">
                                                ...
                                                {/* Mostrar el título del grupo directamente */}
                                                <h4>{key}</h4>
                                            </div>
