...
import type { Ticket, Lead, FunnelStage, Appointment, PropertyType } from './types'
...
export const createLeadObject = (
    ...
    const interestLabels = formData.interest ? [interestToLabel(formData.interest)] : ['Media prioridad'];
    ...
    return {
        ...
        description: formData.description || 'Información del prospecto inmobiliario.',
        cover: '',
        ...
        metadata: {
            ...
            interest: (formData.interest as 'alto' | 'medio' | 'bajo') || 'medio',
            source: formData.source,
            budget: formData.budget ? parseFloat(formData.budget) : undefined,
            propertyType: formData.propertyType,
            preferredZones: formData.preferredZones,
            bedroomsNeeded: formData.bedroomsNeeded ? parseInt(formData.bedroomsNeeded, 10) : undefined,
            bathroomsNeeded: formData.bathroomsNeeded ? parseFloat(formData.bathroomsNeeded) : undefined,
...
export const createAppointmentObject = (leadId: string, agentId: string = 'agent1'): Appointment => {
...
export const leadLabelColors: Record<string, string> = {
    'Alta prioridad': 'bg-rose-200 dark:bg-rose-200 dark:text-gray-900',
    'Media prioridad': 'bg-amber-200 dark:bg-amber-200 dark:text-gray-900',
    'Baja prioridad': 'bg-purple-200 dark:bg-purple-200 dark:text-gray-900',
    'Nuevo contacto': 'bg-blue-200 dark:bg-blue-200 dark:text-gray-900',
    'Compra': 'bg-emerald-200 dark:bg-emerald-200 dark:text-gray-900',
    'Alquiler': 'bg-indigo-200 dark:bg-indigo-200 dark:text-gray-900',
    'Inversión': 'bg-violet-200 dark:bg-violet-200 dark:text-gray-900',
    'Comercial': 'bg-orange-200 dark:bg-orange-200 dark:text-gray-900',
    'Cita agendada': 'bg-cyan-200 dark:bg-cyan-200 dark:text-gray-900',
    'Calificado': 'bg-lime-200 dark:bg-lime-200 dark:text-gray-900',
    'Negociando': 'bg-yellow-200 dark:bg-yellow-200 dark:text-gray-900',
    'Cerrado': 'bg-gray-200 dark:bg-gray-200 dark:text-gray-900',
    'Segunda vivienda': 'bg-teal-200 dark:bg-teal-200 dark:text-gray-900',
    'Opción compra': 'bg-pink-200 dark:bg-pink-200 dark:text-gray-900',
}
