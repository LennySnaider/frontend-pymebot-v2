    ...
    return (
        <div className="flex items-center">
            ...
            <Link
                ...
                href={`/modules/customers/customer-details/${row.id}`}
            >
                {row.name}
            </Link>
        </div>
...
const CustomerListTable = ({
    ...
    const handleEdit = (customer: Customer) => {
        router.push(`/modules/customers/customer-edit/${customer.id}`)
    }

    const handleViewDetails = (customer: Customer) => {
        router.push(`/modules/customers/customer-details/${customer.id}`)
    }
