import {
    ...
    PiGearSixDuotone, // Cambiado de PiSettingsDuotone a PiGearSixDuotone
    PiFileDuotone, // Añadido para el icono fileJson
} from 'react-icons/pi'
...
const navigationIcon: NavigationIcons = {
    ...
    properties: <PiHouseDuotone />,
    leads: <PiUserPlusDuotone />,
    ...
    schedule: <PiCalendarPlusDuotone />,
    ...
    // Nuevos iconos para configuración
    setting: <PiGearSixDuotone />,            // Configuración general
    store: <PiStorefrontDuotone />,           // Información de empresa
    building: <PiBuildingsDuotone />,         // Edificio/Organización
    devices: <PiDevicesDuotone />,            // Integraciones
    bell: <PiBellDuotone />,                  // Notificaciones
