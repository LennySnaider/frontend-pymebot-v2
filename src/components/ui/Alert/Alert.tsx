...
const Alert = (props: AlertProps) => {
    ...
    // Modificar el comportamiento del timeout solo para el caso en que duration > 0
    const { clear } = useTimeout(
        onClose as () => void,
        duration,
        (duration as number) > 0 && triggerByToast, // Solo aplicar timeout si es un toast o se especificó explícitamente
    )
