/**
 * frontend/src/components/verticals/belleza/dashboard/Dashboard.tsx
 * Componente de dashboard para la vertical de Belleza.
...
/**
 * Dashboard principal para la vertical de Belleza
 */
    ...
    <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm">
      <header className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800 dark:text-white flex items-center">
          ...
          Dashboard de {bellezaVerticalInfo.name}
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatCard
          ...
          loading={loading}
          color={bellezaVerticalInfo.colors?.primary || '#D81B60'}
        />
        ...
        <StatCard
          ...
          loading={loading}
          color={bellezaVerticalInfo.colors?.secondary || '#F06292'}
        />
        ...
        <StatCard
          ...
          loading={loading}
          color={bellezaVerticalInfo.colors?.accent || '#FF94C2'}
        />
      ...
      <div className="mt-8">
        ...
        <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
          <p className="text-gray-600 dark:text-gray-300">
            Esta es una versión de demostración del dashboard para la vertical de Belleza.
